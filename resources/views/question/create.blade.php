                ...
                <div class="card-body">
                  <form action="{{route('CreateQuestions')}}" method="POST">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="title" id="qtitle" class="form-control {{$errors->has('title') ? 'is-invalid':''}}">
                          @if($errors->has('title'))
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="body" id="qbody" class="form-control {{$errors->has('body') ? 'is-invalid' :''}}" row="10"></textarea>
                          @if($errors->has('body'))
                          <div class="invalid-feedback">
